...
public class TestVerify {
    ...
    public TestVerify(long seed) {
        this.seed0 = murmurHash3(seed == 0L ? Long.MIN_VALUE : seed);
        this.seed1 = murmurHash3(this.seed0);
        System.out.println("Initial state: seed0=" + seed0 + ", seed1=" + seed1);
    }
    ...
    public static void main(String[] args) {
        ...
        TestVerify rng = new TestVerify(seed);

        System.out.println("\n=== First nextLong() ===");
        long nl1 = rng.nextLong();
        System.out.println("nextLong() = " + nl1 + " (0x" + Long.toHexString(nl1) + ")");
        System.out.println("State after: seed0=" + rng.seed0 + ", seed1=" + rng.seed1);

        System.out.println("\n=== First nextInt(6) ===");
        rng = new TestVerify(seed);  // reset
        int ni1 = rng.nextInt(6);
        System.out.println("nextInt(6) = " + ni1);
        System.out.println("State after: seed0=" + rng.seed0 + ", seed1=" + rng.seed1);

        System.out.println("\n=== First randomIntBetween(10, 15) ===");
        rng = new TestVerify(seed);  // reset
        int rb1 = rng.randomIntBetween(10, 15);
        System.out.println("randomIntBetween(10, 15) = " + rb1);
    }
}